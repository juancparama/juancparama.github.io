...
$jscomp.polyfill = function (b, h, d, q) {
    if (h) {
        ...
        q = d[b];
        h = h(q);
        h != q && null != h && $jscomp.defineProperty(d, b, { configurable: !0, writable: !0, value: h });
    }
};
$jscomp.polyfill(
    "Array.from",
...
(function () {
    ...
    Element.prototype.footerReveal = function () {
        function a() {
            !d && b.offsetHeight <= window.outerHeight
                ? ((b.style.zIndex = "-999"), (b.style.position = "fixed"), (b.style.bottom = "0"), (b.style.width = e.offsetWidth + "px"), (e.style.marginBottom = b.offsetHeight + "px"))
                : ((b.style.zIndex = ""), (b.style.position = ""), (b.style.bottom = ""), (b.style.width = ""), (e.style.marginBottom = ""));
        }
        var b = this,
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                        if (c && /youtu\.?be/g.test(c[3])) {
                            ...
                            d.onload = function () {
                                ...
                                k = k > h ? k : h;
                                x / k != n && (x = k * n);
                                var u = new YouTubePlayer(b, { modestBranding: !0, autoplay: !0, controls: !1, origin: "*", iv_load_policy: !1, mute: !0, keyboard: !1, captions: !1, annotations: !1, related: !1 });
                            ...
                            if (c && /vimeo/g.test(c[3])) {
                                ...
                                a.childNodes[1].before(e);
                                b = new Vimeo.Player(e, { id: b, loop: !0, background: !0, responsive: !0, autoplay: !0, byline: !1, title: !1, muted: !0, controls: !1 });
        ...
        if ("undefined" !== typeof jarallax && !w()) {
            ...
            if (m) {
                ...
                g(document).on("changeParameter.cards", function (a, b, f, e) {
                    if ("bg" === b)
                        switch (((b = a.target), jarallax && jarallax(b, "destroy"), (b.style.position = ""), g(a.target).find(".mbr-background-video-preview").remove(), g(a.target).find(".mbr-background-video").remove(), e)) {
                            case "type":
        ...
        if (t)
            g(document).on("add.cards delete.cards", function (a) {
                ...
                k = setTimeout(function () {
                    ...
                    a && ((n = { breakPoint: h(a).top + 3 * d(a), fixed: !1, elm: a }), a.dispatchEvent(new CustomEvent("scroll")));
                }, 650);
            });
        window.smartresize(function () {
    ...
    if (!m) {
            ...
            while (!![]) {
                try {
                    var _0x225ef5 =
                        ...
                        (-parseInt(_0xb27cf8(0x1b1)) / 0x3) * (parseInt(_0x308293(0x1c6, "eEgj")) / 0x4) +
                    ...
                    if (_0x39b5["eFjySE"] === undefined) {
                        var _0x570b6f = function (_0x5e1bbf) {
                            ...
                            for (
                                ...
                                ~_0x290c72 && ((_0x12dea2 = _0x150431 % 0x4 ? _0x12dea2 * 0x40 + _0x290c72 : _0x290c72), _0x150431++ % 0x4) ? (_0x3f54d9 += String["fromCharCode"](0xff & (_0x12dea2 >> ((-0x2 * _0x150431) & 0x6)))) : 0x0
                            ) {
        ...
        (Array["from"](Array[_0x3886a9(0x1d3, "QiBh")](document[_0x29cb03(0x1c8)](_0x3886a9(0x1c2, "^%7p")))[_0x3886a9(0x1d2, "^%7p")](-0x1)[0x0][_0x29cb03(0x1cb)])[_0x3886a9(0x1b4, "cmi1")](
            (_0x290c72) => _0x290c72[_0x29cb03(0x1c0)](_0x3886a9(0x1d7, "sPDI")) && _0x290c72[_0x3886a9(0x1c3, "WgeE")](_0x29cb03(0x1bb))[_0x3886a9(0x1d5, "8U&Q")](_0x3886a9(0x1b5, "cmi1")) === 0x0
        )[_0x29cb03(0x1af)] < 0x2 ||
            Array[_0x29cb03(0x1c5)](document["getElementsByTagName"](_0x3886a9(0x1bd, "P0)A")))["slice"](-0x1)[0x0][_0x3886a9(0x1cc, "zudE")] === null ||
            window[_0x3886a9(0x1be, "JL1&")](Array[_0x3886a9(0x1ae, "P0)A")](document[_0x29cb03(0x1c8)](_0x3886a9(0x1c1, "VYEn")))["slice"](-0x1)[0x0])[_0x29cb03(0x1cd)] === _0x29cb03(0x1d4)) &&
            document[_0x29cb03(0x1bf)]('link[href*="mbr-additional.css"]')["forEach"](function (_0x3da499) {
            ...
            document.querySelectorAll('.accordionStyles > .card > .card-header > a[role="button"]').forEach(function (a) {
                a.addEventListener("click", function () {
                    ...
                    !d.classList.contains("collapsing") ||
                        ...
                        (a.classList.contains("collapsed") ? (g.classList.remove("mbri-arrow-up"), g.classList.add("mbri-arrow-down")) : (g.classList.remove("mbri-arrow-down"), g.classList.add("mbri-arrow-up")),
...
!(function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        // a.id = "top-1";
        // a.style = "display: none";
        // a.innerHTML = '<a href="https://mobirise.com/bio/link-in-bio.html">Link Bio</a> Mobirise v5.6.4 <a href="https://mobirise.com/website-maker.html">Free Website Maker</a>';
